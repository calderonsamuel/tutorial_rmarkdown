...
<ol start=2><li>Hacer click en "New Project"</li>

![](images/crear-proyecto-02.png){width=100%}

---

<ol start=3><li>Elegir "New directory"</li>

![](images/crear-proyecto-03.png)

---

<ol start=4><li>Elegir "New project"</li>
...
<ol start=5><li>Indicar el nombre del proyecto</li>

![](images/crear-proyecto-05.png)

---

<ol start=6><li>Elegir la carpeta en la que se guardará el proyecto</li> 
...
<ol start=7><li>Hacer click en "Create project"</li>
...
Va a solicitar packrat, rsconnect. En algunos casos solo publica desde microsoft edge. (revisar navegador por defecto)
...
El objetivo es poder replicar [este artículo](https://www.bbc.com/mundo/noticias-america-latina-56994622) de la BBC acerca del coronavirus. Lo haremos usando la Guía de Referencia de R Markdown para saber cómo escribir.
...
![](images/articulo-bbc.png){width=100%}
---
